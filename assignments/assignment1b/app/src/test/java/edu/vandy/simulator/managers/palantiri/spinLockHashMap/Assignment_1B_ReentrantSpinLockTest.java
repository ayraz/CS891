...
public class Assignment_1B_ReentrantSpinLockTest {
    ...
    public void testTryLock() {
        ...
        assertEquals("Recursion count should be 0.", 0, spinLock.mRecursionCount);
    }
    ...
    public void testLockWhenUnlocked() {
        ...
        assertEquals("Recursion count should be 1.", 1, spinLock.mRecursionCount);
    }
    ...
    public void testLockWhenAlreadyLockedButIsReentrant() {
        ...
        verify(isCancelled, never()).get();
        verify(owner, never()).compareAndSet(any(), any());
        assertEquals("Recursion count should be 3.", 3, spinLock.mRecursionCount);
    }
